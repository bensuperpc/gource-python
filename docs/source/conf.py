...
from gource_python import VERSION, VERSION_SHORT  # noqa: E402

# -- Project information -----------------------------------------------------

project = "gource-python"
...
html_title = f"gource-python v{VERSION}"
...
html_theme_options = {
    "footer_icons": [
        {
            "name": "GitHub",
            "url": "https://github.com/bensuperpc/gource-python",
            "html": """
